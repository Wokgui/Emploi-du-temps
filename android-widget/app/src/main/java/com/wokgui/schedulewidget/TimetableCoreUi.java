            ...
            (function(){
              try {
                ...
                function applyAppAppearance(){
                  ...
                  document.querySelectorAll('.classTint,.classFill').forEach(el=>{el.classList.remove('classTint','classFill');el.style.removeProperty('--class-color')});
                  if(mode==='none')return;
                  const decorate=(el,label)=>{el.classList.add(mode==='fill'?'classFill':'classTint');el.style.setProperty('--class-color',classColor(label))};
            ...
            (function(){
              try {
                ...
                function apply(el,id,gradient){
                  ...
                  if(mode==='stripe'){el.style.setProperty('border-left','4px solid '+c,'important');return}
                  el.style.setProperty('background',c,'important');el.style.setProperty('box-shadow','inset 0 0 0 1px '+c,'important');
                }
