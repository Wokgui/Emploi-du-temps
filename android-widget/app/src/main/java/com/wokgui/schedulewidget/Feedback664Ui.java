            ...
            (function(){
              try{
                ...
                const style=document.createElement('style');style.id='feedback664Style';style.textContent=`
                  ...
                  #advancedSettings85 .feedback664Profiles #advProfileSelect{display:block!important;width:72%!important;max-width:260px!important;min-width:150px!important;margin:0 auto!important;padding:9px 32px!important;border:1px solid #cfd9e5!important;border-radius:12px!important;background-color:#fff!important;background-image:linear-gradient(45deg,transparent 50%,#526176 50%),linear-gradient(135deg,#526176 50%,transparent 50%)!important;background-position:calc(100% - 19px) 50%,calc(100% - 14px) 50%!important;background-size:5px 5px!important;background-repeat:no-repeat!important;appearance:none!important;text-align:center!important;text-align-last:center!important;font-weight:750!important;color:#233047!important}
