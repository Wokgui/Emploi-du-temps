            ...
            (function(){
              try{
                ...
                const style=document.createElement('style');style.id='weekAppearance658Style';style.textContent=`
                  ...
                  html body #viewWeek #weekGrid#weekGrid .wc:is(.week658Lunch,.lunchCell,.dynamicLunchCell,.nativeLunchCell,.finalLunchCell,.lunch655Synthetic){background:var(--week658-lunch,#FFE08A)!important;background-color:var(--week658-lunch,#FFE08A)!important}
                  html body #viewWeek #weekGrid#weekGrid .wc:is(.week658Lunch,.lunchCell,.dynamicLunchCell,.nativeLunchCell,.finalLunchCell,.lunch655Synthetic) .dynamicLunchOverlay,
                  html body #viewWeek #weekGrid#weekGrid .wc:is(.week658Lunch,.lunchCell,.dynamicLunchCell,.nativeLunchCell,.finalLunchCell,.lunch655Synthetic) .nativeLunchLabel{background:transparent!important;background-color:transparent!important}
