...
/** Final narrow-screen layout polish for 6.44. Pure CSS: no observers, timers or wrappers. */
final class Polish644Ui {
    ...
    static String script() {
        return """
            (function(){
              try{
                if(document.getElementById('polish644Style'))return;
                ...
                style.textContent=`
                  ...
                  /* The card already says “Affichage du widget”: remove the duplicate section caption. */
