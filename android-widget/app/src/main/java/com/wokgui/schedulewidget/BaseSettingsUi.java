            ...
            (function(){
              try {
                ...
                style.textContent=`
                  ...
                  #settingsTitle .settingsGear741{position:absolute;right:calc(100% + 7px);top:50%;transform:translateY(-50%);display:flex;align-items:center;justify-content:center;width:18px;height:18px;min-width:18px;color:#111936;pointer-events:none}
                  #settingsTitle .settingsGear741 svg{display:block;width:18px;height:18px;overflow:visible}
                  #settingsTitle .settingsGear741 .gearBody741{fill:currentColor}
                  #settingsTitle .settingsGear741 .gearHole741{fill:#fff;stroke:currentColor;stroke-width:1.4}
                  #settingsTitle .settingsGear741 .gearShine741{fill:none;stroke:#ffffffb8;stroke-width:.75;stroke-linecap:round}
