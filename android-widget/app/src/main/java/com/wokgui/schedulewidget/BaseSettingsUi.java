            ...
            (function(){
              try {
                ...
                style.textContent=`
                  ...
                  #settingsTitle .settingsTitleGroup741{position:relative;display:inline-flex;align-items:center;justify-content:center;min-height:22px}
                  html body #settingsSheet #settingsTitle .settingsGear741{position:absolute!important;right:calc(100% + 7px)!important;top:50%!important;transform:translateY(-50%)!important;display:flex!important;align-items:center!important;justify-content:center!important;width:20px!important;height:20px!important;min-width:20px!important;background:none!important;background-image:none!important;color:#263243!important;pointer-events:none!important}
                  html body #settingsSheet #settingsTitle .settingsGear741 svg{display:block!important;width:20px!important;height:20px!important;overflow:visible!important;fill:none!important;filter:none!important}
                  #settingsTitle .settingsGear741 .gearBody742{fill:url(#gearMetal742)!important;stroke:#1b2533!important;stroke-width:.45!important;stroke-linejoin:round!important;filter:url(#gearShadow742)!important}
                  #settingsTitle .settingsGear741 .gearRing742{fill:url(#gearHub742)!important;stroke:#192331!important;stroke-width:.8!important}
                  #settingsTitle .settingsGear741 .gearHole742{fill:#f7f9fc!important;stroke:#2c3949!important;stroke-width:.8!important}
                  #settingsTitle .settingsGear741 .gearShine742{fill:none!important;stroke:#ffffffc7!important;stroke-width:.72!important;stroke-linecap:round!important;opacity:.9!important}
                  #settingsTitle .settingsText741{display:block;line-height:22px;white-space:nowrap}
                ...
                modal.innerHTML=`<div id="settingsSheet"><div class="settingsHead"><h2 id="settingsTitle"><span class="settingsTitleGroup734 settingsTitleGroup735 settingsTitleGroup741"><span class="settingsGear734 settingsGear735 settingsGear741" aria-hidden="true"><svg viewBox="0 0 24 24" focusable="false"><defs><linearGradient id="gearMetal742" x1="4" y1="3" x2="20" y2="21" gradientUnits="userSpaceOnUse"><stop offset="0" stop-color="#a9b5c4"/><stop offset=".28" stop-color="#647286"/><stop offset=".62" stop-color="#364355"/><stop offset="1" stop-color="#172131"/></linearGradient><radialGradient id="gearHub742" cx="9.5" cy="8.5" r="7.5" gradientUnits="userSpaceOnUse"><stop offset="0" stop-color="#8f9cad"/><stop offset=".55" stop-color="#4c596a"/><stop offset="1" stop-color="#253142"/></radialGradient><filter id="gearShadow742" x="-30%" y="-30%" width="160%" height="170%"><feDropShadow dx="0" dy=".75" stdDeviation=".55" flood-color="#0c1320" flood-opacity=".45"/></filter></defs><path class="gearBody742" d="M10.25 2.05h3.5l.5 2.2c.58.18 1.12.41 1.62.69l1.91-1.19 2.47 2.47-1.19 1.91c.28.5.51 1.04.69 1.62l2.2.5v3.5l-2.2.5a7.7 7.7 0 0 1-.69 1.62l1.19 1.91-2.47 2.47-1.91-1.19c-.5.28-1.04.51-1.62.69l-.5 2.2h-3.5l-.5-2.2a7.7 7.7 0 0 1-1.62-.69l-1.91 1.19-2.47-2.47 1.19-1.91a7.7 7.7 0 0 1-.69-1.62l-2.2-.5v-3.5l2.2-.5c.18-.58.41-1.12.69-1.62L3.75 6.22l2.47-2.47 1.91 1.19c.5-.28 1.04-.51 1.62-.69l.5-2.2Z"/><circle class="gearRing742" cx="12" cy="12" r="4.25"/><circle class="gearHole742" cx="12" cy="12" r="2.05"/><path class="gearShine742" d="M6.8 7.45A7.45 7.45 0 0 1 11 5.15M8.9 10.15A3.8 3.8 0 0 1 11.1 8.4"/></svg></span><span id="settingsTitleText741" class="settingsText734 settingsText735 settingsText741"></span></span></h2><button id="settingsX" class="settingsX" type="button">×</button></div><div class="previewGrid"><div><div id="appPreviewLabel" class="previewLabel"></div><div class="preview"><div id="previewAppTitle" class="previewAppTop"></div><div class="previewBody"><div class="previewLine accent"></div><div class="previewLine"></div><div class="previewLine"></div></div></div></div><div><div id="widgetPreviewLabel" class="previewLabel"></div><div class="preview"><div class="previewWidget"><div class="previewWidgetTitle">4G1 ALL · 4G2 ALL</div><div class="previewWidgetMeta">08:00 - 09:00</div><div class="previewBar"><i></i></div></div></div></div></div><div class="settingBox"><div id="appFontTitle" class="settingTitle"></div><div class="settingRow"><input id="appFont" type="range" min="80" max="140" step="5"><span id="appFontValue" class="settingValue"></span></div></div><div class="settingBox"><div id="widgetFontTitle" class="settingTitle"></div><div class="settingRow"><input id="widgetFont" type="range" min="80" max="140" step="5"><span id="widgetFontValue" class="settingValue"></span></div></div><div class="settingBox"><div id="languageTitle" class="settingTitle"></div><select id="languageSelect" class="languageSelect"><option value="fr">Français</option><option value="de">Deutsch</option><option value="en">English</option></select></div><div class="settingBox"><div id="themeTitle" class="settingTitle"></div><div id="themeGrid" class="themeGrid"></div></div><div class="settingsActions"><button id="settingsReset" class="settingsAction" type="button"></button><button id="settingsDone" class="settingsAction primary" type="button"></button></div></div>`;
