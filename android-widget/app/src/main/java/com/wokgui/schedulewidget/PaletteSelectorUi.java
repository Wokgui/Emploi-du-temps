...
final class PaletteSelectorUi {
    ...
    static String script() {
        return """
            (function(){
              try {
                if(window.__coursePaletteUiV2){
                  if(window.refreshCoursePaletteV2)window.refreshCoursePaletteV2();
                  return;
                }
                window.__coursePaletteUiV2=true;
                ...
                style.textContent=`
                  #widgetPaletteSetting .settingTitle{margin-bottom:3px}
                ...
                if(typeof originalRefresh==='function'&&!originalRefresh.__paletteWrappedV2){const wrapped=function(){const r=originalRefresh.apply(this,arguments);setTimeout(repaint,0);return r};wrapped.__paletteWrappedV2=true;window.refreshCourseColors=wrapped}

                window.refreshCoursePaletteV2=repaint;
                repaint();
