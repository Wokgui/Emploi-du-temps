            ...
            (function(){
              try {
                ...
                function localize(){
                  ...
                  const cw=document.getElementById('currentWeekBtn');if(cw){const l=cw.querySelector('b')?cw.querySelector('b').textContent:'A';cw.innerHTML=t.thisWeek+' : <b>'+l+'</b>'}
                ...
                function wrap(name){const original=window[name];if(typeof original!=='function'||original.__settingsWrapped)return;const wrapped=function(){const result=original.apply(this,arguments);setTimeout(refresh,0);return result};wrapped.__settingsWrapped=true;window[name]=wrapped}
