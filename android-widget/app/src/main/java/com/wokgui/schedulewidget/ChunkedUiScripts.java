...
final class ChunkedUiScripts {
    ...
    static String[] all() {
        ...
        add(out, Feedback680Ui.script());
        add(out, Feedback687Ui.script());
        add(out, Feedback689Ui.script());
    ...
    private static void add(List<String> out, String script) {
        ...
        out.add(script.replace("APP_VERSION='6.45'", "APP_VERSION='6.65'")
                      ...
                      .replace("APP_VERSION='6.79'", "APP_VERSION='6.80'")
                      .replace("APP_VERSION='6.80'", "APP_VERSION='6.81'")
                      .replace("APP_VERSION='6.81'", "APP_VERSION='6.82'")
                      .replace("APP_VERSION='6.82'", "APP_VERSION='6.83'")
                      .replace("APP_VERSION='6.83'", "APP_VERSION='6.84'")
                      .replace("APP_VERSION='6.84'", "APP_VERSION='6.85'")
                      .replace("APP_VERSION='6.85'", "APP_VERSION='6.86'")
                      .replace("APP_VERSION='6.86'", "APP_VERSION='6.87'")
                      .replace("APP_VERSION='6.87'", "APP_VERSION='6.88'")
                      .replace("APP_VERSION='6.88'", "APP_VERSION='6.89'")
                      .replace("APP_VERSION='6.89'", "APP_VERSION='6.90'")
                      .replace("APP_VERSION='6.90'", "APP_VERSION='6.91'"));
    }
}
